...
<!-- gallery -->
	<div class="gallery" id="gallery">
		<div class="container">
			<h3>Menu<span> Martabak Suka Hati</span></h3>
			<div class="agile_gallery_grids">
				<ul class="clearfix demo">
					<?php
    //query ke database dg SELECT table siswa diurutkan berdasarkan NIS paling besar
   $query = mysqli_query($con,"SELECT * FROM tbl_martabak where nama_menu='$_GET[nama_menu]' ORDER BY id_martabak ASC") or die(mysql_error());    
					...
					<li>
						...
						<div class="gallery-grid1">
							...
							<div class="p-mask">
								...
								<p> <?php echo $data['harga_martabak'] ;?></p>
